class ApiRoutes {
  ...
  static const alertSubCategoriesList =
      "/categories/tree?categoryId={categoryId}";
  ...
  static const postRequestedItem = "/item/post-request";
  static const pickupOptions = "/item/pickup-options";

  static String updateItem(String id) => "/item/update/$id";
