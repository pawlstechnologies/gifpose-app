...
AnalyseImageResponse analyseImageResponseFromJson(String str) => AnalyseImageResponse.fromJson(json.decode(str));

String analyseImageResponseToJson(AnalyseImageResponse data) => json.encode(data.toJson());
...
class AnalyseImageResponse {
    ...
    factory AnalyseImageResponse.fromJson(Map<String, dynamic> json) => AnalyseImageResponse(
...
class Subcategory {
    ...
    factory Subcategory.fromJson(Map<String, dynamic> json) => Subcategory(
        ...
        status: json["status"],
        slug: json["slug"],
        contents: List<Category>.from(json["contents"].map((x) => Category.fromJson(x))),
    );
