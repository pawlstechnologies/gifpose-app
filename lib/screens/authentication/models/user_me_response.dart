...
UserMeResponse userMeResponseFromJson(String str) =>
    UserMeResponse.fromJson(json.decode(str));
...
class UserMeResponse {
  ...
  UserMeResponse({required this.status, required this.message, this.user});
