...
class _DetailsPageState extends State<DetailsPage> {
                                                  ...
                                                  children: [
                                                    ...
                                                    Row(
                                                      children: [
                                                        ...
                                                        XMargin(5),
                                                        Text(
                                                          "Tram".tr(context) + " ${vm.fetchItemsByIdMeResponse.data?.data?.estimatedTravelTime?.publicTransport ?? ""}",
                                                          textAlign:
                                                              TextAlign.justify,
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        ...
                                                        XMargin(5),
                                                        Text(
                                                          "Underground".tr(context) + ": ${vm.fetchItemsByIdMeResponse.data?.data?.estimatedTravelTime?.publicTransport ?? ""}",
                                                          textAlign:
                                                              TextAlign.justify,
                                                    ...
                                                    Row(
                                                      children: [
                                                        ...
                                                        XMargin(5),
                                                        Text(
                                                          "Bus".tr(context) + ": ${vm.fetchItemsByIdMeResponse.data?.data?.estimatedTravelTime?.publicTransport ?? ""}",
                                                          textAlign:
                                                              TextAlign.justify,
 ...
 YMargin(18),
                                    GiftPoseButton(
                                      title: "Mark as Taken".tr(context),
                                    ...
                                    YMargin(24),
                                    GiftPoseButton(
                                      title: "Visit Freebies".tr(context),
                                      textColor: Theme.of(
                                        context,
                                      ).scaffoldBackgroundColor,
                                      onTap: () {
